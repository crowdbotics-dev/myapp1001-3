"""
Django settings for myapp1001_3 project.
...
WSGI_APPLICATION = 'myapp1001_3.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "myapp1001_3 API",
    "DESCRIPTION": "API documentation for myapp1001_3 App",
    "VERSION": "v1",
}
